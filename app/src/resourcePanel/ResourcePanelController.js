(function(){
    ...
    angular.module('resourcePanel')
        .controller('ResourcePanelController',['$scope','$mdDialog','ResourcePanelService',ResourcePanelController]);

    function ResourcePanelController($scope, $mdDialog, ResourcePanelService){
        updateLBlist();
...
//LB池管理
       ...
       function LBcenterController($scope,$mdDialog){
           $scope.cancel = function () {
               $mdDialog.cancel();
           };
