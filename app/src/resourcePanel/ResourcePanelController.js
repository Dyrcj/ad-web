(function(){
    ...
    angular.module('resourcePanel')
        .controller('ResourcePanelController',['$scope','$mdDialog','ResourcePanelService','$state',ResourcePanelController])
        .controller('LBcenterController', ['$scope', 'ResourcePanelService', '$state','$stateParams', '$sessionStorage', LBcenterController]);
